...
ALTER FUNCTION fw.f_create_ext_table(text, int8, text, text, text, text, text, bool) OWNER TO role_fw_owner;
GRANT ALL ON FUNCTION fw.f_create_ext_table(text, int8, text, text, text, text, text, bool) TO public;
GRANT ALL ON FUNCTION fw.f_create_ext_table(text, int8, text, text, text, text, text, bool) TO role_fw_owner;
