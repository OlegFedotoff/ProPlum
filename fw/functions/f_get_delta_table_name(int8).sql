-- DROP FUNCTION fw.f_get_delta_table_name(int8);
...
BEGIN
  ...
  v_tmp_table_name = v_schema_name||'.'||coalesce(fw.f_get_constant('c_delta_table_prefix'),'delta_')||v_table_name||'_'||v_object_id;--||'_'||p_load_id ;
   perform fw.f_write_log(
     p_log_type    := 'SERVICE', 
