-- DROP FUNCTION fw.f_get_ext_table_name(int8);
...
BEGIN
  ...
  v_ext_table_name = v_schema_name||'.'||coalesce(fw.f_get_constant('c_ext_table_prefix'),'ext_')||v_table_name||'_'||v_object_id;--||'_'||p_load_id;
