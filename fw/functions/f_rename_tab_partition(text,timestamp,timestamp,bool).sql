-- DROP FUNCTION fw.f_rename_tab_partition(text, timestamp, timestamp, bool);

CREATE OR REPLACE FUNCTION fw.f_rename_tab_partition(p_schema_name text, p_partition_start timestamp, p_partition_end timestamp, p_flag_log bool DEFAULT false)
	RETURNS bool
	LANGUAGE plpgsql
	VOLATILE
AS $$
